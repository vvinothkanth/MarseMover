            ...
            while (isProcessContinue)
            {
                ...
                switch (option)
                {
                    case (int)Option.CreateRover:
                        ...
                        beetaRover.SetPosition(Convert.ToInt16(roverValues[0]), Convert.ToInt16(roverValues[1]), Convert.ToInt16(roverValues[2]), Convert.ToChar(roverValues[3]));
                    ...
                    case (int)Option.CreateArea:
                        ...
                        plateauOne.SetBoundaryPoint(Convert.ToInt16(areaValues[0]), Convert.ToInt16(areaValues[1]), Convert.ToInt16(areaValues[2]), Convert.ToInt16(areaValues[3]), Convert.ToInt16(areaValues[4]));
